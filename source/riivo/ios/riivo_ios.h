...
typedef struct
{
	...
	/* RIV1 service. Ignored unless tableKind is RIIVO_TABLE_RIV1; every
	   word of it is checked at init before a single read is served.
	   Appended after the counters so the original eight words never move. */
